...
import com.geniusapk.mychat.databinding.ActivityMainBinding
        ...
        mDbRef.child("user").addValueEventListener(object: ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (postSnapshot in snapshot.children){
                    ...
                    if (mAuth.currentUser?.uid != currentUser?.uid){  //if the current user is not equal to the current user
